              ...
              <div class="side-header">
                  <a class="header-brand1" href="{{ url('administrator/dashboard') }}">
                      <img src="{{ asset('assets/admin/images/brand/logo.png') }}" class="header-brand-img desktop-logo"
                          alt="logo">
                      <img src="{{ asset('assets/admin/images/brand/logo-1.png') }}"
                          class="header-brand-img toggle-logo" alt="logo">
                      <img src="{{ asset('assets/admin/images/brand/logo-2.png') }}" class="header-brand-img light-logo"
                          alt="logo">
                      <img src="{{ asset('assets/admin/images/brand/logo-3.png') }}"
              ...
              <div class="main-sidemenu">
                  ...
                  <ul class="side-menu">
                      ...
                      <li class="slide">
                          ...
                          <ul class="slide-menu">
                              <li><a href="{{ url('administrator/user') }}" class="slide-item">List Users</a></li>
                          </ul>
                      </li>
                  </ul>
